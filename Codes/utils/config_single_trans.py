...
class config:
    def __init__(self):
        ...
        self.source_data_name = 'Orthomy'
        self.neg_type = 'adap_sam'#'random', 'kmers_stat', 'seq_sim' 'adap_sam'
        self.seq_type = 'lstm' # lstm gru
        self.data_name = 'HH8'#BPPLM 'coronavirus' 'MHV1' 'HIV1' 'Ebola' 'HHV1' 'Zika' VirusMentha Orthomy 'VirusMINT', BioGRID, nonIntAct
        ...
        self.n_classes = 2
        # Set random seeds
        self.seed = 666# 42 6657 2024 123 666
        self.fold = 5# 1 2 3 4 5
        # Training parameters
